    ...
    return (<>
        <div
            ...
            transition={{ duration: .5,delay:1 }}
                ...
                <h5 className="font-dmserif text-red max-sm:text-h1 sm:text-h3 md:text-h5">
                    Today's Special
                </h5>
                <h4 className="font-dmsans text-white max-sm:text-[16px] sm:text-[20px] md:text-h3 lg:text-h4">
